...
<body class="grey lighten-3">
  ...
  <div class="container">
    ...
    <div class="form-group">
      ...
      <label class="form-control"><?php echo $usuario->getNombre() ?></label>
    </div>

    <div class="form-group">
      <label for="clave">Clave: </label>
      <label class="form-control"><?php echo $usuario->getClave() ?></label>
    </div>

    <div class="form-group">
      <label for="estado">Estado</label>
      <label class="form-control"><?php echo $usuario->getEstado() ?></label>
    </div>

    <hr>
    <td><a class="waves-effect waves-light btn  red darken-1" href='../../controller/usuario_controller.php?action=delete&id=<?php echo $usuario->id ?>'>Eliminar</a></td>
