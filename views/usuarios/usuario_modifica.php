  ...
  <nav class="nav-extended">
    ...
    <div class="nav-content amber darken-3">
      <ul class="tabs tabs-transparent">
        ...
        <li class="tab"><a style="font-size:20px" href="../../views/detalle_pedido/detalle_pedido.php"><b>Detalles</a></li>
      </ul>
    </div>
  </nav>
  ...
  <div class="container">
    ...
    <form id="nuevo" name="nuevo" method="POST" action="../../controller/usuario_controller.php" autocomplete="off">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $usuario->getNombre() ?>" />
      </div>

      <div class="form-group">
        <label for="clave">Clave</label>
        <input type="text" class="form-control" id="clave" name="clave" value="<?php echo $usuario->getClave() ?>" />
      </div>

      <div class="form-group">
        <label for="estado">Estado</label>
        <input type="text" class="form-control" id="estado" name="estado" value="<?php echo $usuario->getEstado() ?>" />
      </div>
