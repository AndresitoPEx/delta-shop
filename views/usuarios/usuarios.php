...
<body class="grey lighten-3">
  ...
  <div class="container">
    ...
    <h2>Usuarios</h2>
    <div class="row">
      <div class="col s12 m6 50"><a href="/dtg_mvc/views/usuarios/usuario_nuevo.php" class="waves-effect waves-light btn  orange darken-1">AGREGAR</a></div>
          ...
          ?>
            <div>
              <tr>
                ...
                <td class=""><?php echo $lista[$i]->getClave() ?></td>
                <td class=""><?php echo $lista[$i]->getEstado() ?></td>

                <td><a class="waves-effect waves-light btn  light blue darken-1" href='/dtg_mvc/views/usuarios/usuario_modifica.php?id=<?php echo $lista[$i]->id ?>'>Editar</a></td>
                <td><a class="waves-effect waves-light btn  red darken-1" href='/dtg_mvc/views/usuarios/usuario_elimina.php?id=<?php echo $lista[$i]->id ?>'>Eliminar</a></td>
