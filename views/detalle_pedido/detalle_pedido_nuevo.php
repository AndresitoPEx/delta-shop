...
$productos=Product_model::getAll();
...
<div class="container">
		...
		<form id="nuevo" name="nuevo" method="POST" action="../../controller/detalle_controller.php" autocomplete="off">
			<div class="form-group">
				...
				<br>
				<a href="/dtg_mvc/views/pedidos/pedidos.php?view=search" class="waves-effect waves-light btn-small">Buscar</a>
				
				<input value="<?php echo $pedido_id?>" type="text" class="form-control" id="pedidos_id" name="pedidos_id" />
			
			</div>

			<div class="form-group">
				<label for="productos_id">Producto</label>
				<select value="" class="browser-default" id="productos_id" name="productos_id" >
				<option value=""></option>
				<?php foreach ($productos as $producto) { ?>
					<option value="<?php echo $producto->id; ?>"><?php echo $producto->getNombre(); ?></option>
					<?php } ?>
				</select>
			</div>
