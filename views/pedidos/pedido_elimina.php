...
<nav class="nav-extended">
  ...
  <a href="/dtg_mvc/index.php" class="brand-logo"><img class="responsive-img"  src="../../assets/img/delta.png" width="250" style="margin-left:55px;"></a>
    ...
    <div class="container">
        ...
        <h2>Estas seguro de eliminar este Pedido: </h2>


            <div class="form-group">
                <label for="cliente_id">ID Cliente:  </label>
                <label  class="form-control"><?php echo $pedido->getClienteId() ?></label>
            </div>

            <div class="form-group">
                <label for="total">Total: </label>
                <label  class="form-control"><?php echo $pedido->getTotal() ?></label>
            </div>

            <div class="form-group">
                <label for="fecha">Fecha</label>
                <label  class="form-control"><?php echo $pedido->getFecha() ?></label>
            </div>

            <div class="form-group">
                <label for="estado">Estado</label>
                <label  class="form-control"><?php echo $pedido->getEstado() ?></label>
            </div>


                <hr>
                <td><a class="waves-effect waves-light btn  red darken-1" href='../../controller/pedido_controller.php?action=delete&id=<?php echo $pedido->id?>'>Eliminar</a></td>
