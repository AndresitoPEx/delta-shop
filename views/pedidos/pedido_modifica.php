    ...
    <div class="container">
        ...
        <form id="nuevo" name="nuevo" method="POST" action="../../controller/pedido_controller.php" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="cliente_id" name="cliente_id" value="<?php echo $pedido->getClienteId() ?>" />
            </div>

            <div class="form-group">
                <label for="total">Total</label>
                <input type="number" class="form-control" id="total" name="total" value="<?php echo $pedido->getTotal() ?>" />
            </div>

            <div class="form-group">
                <label for="fecha">Fecha de Entrega</label>
                <input type="date" class="form-control" id="fecha" name="fecha" value="<?php echo $pedido->getFecha() ?>" />
            </div>

            <div class="form-group">
                <label for="estado">Estado</label>
                <input type="text" class="form-control" id="estado" name="estado" value="<?php echo $pedido->getEstado() ?>" />
            </div>
