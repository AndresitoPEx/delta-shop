...
<body class="grey lighten-3">
  ...
  <div class="container">
    ...
    <h2>Pedidos</h2>
    <div class="row">
      <div class="col s12 m6 50"><a href="/dtg_mvc/views/pedidos/pedido_nuevo.php" class="waves-effect waves-light btn  orange darken-1">AGREGAR</a></div>
          ...
          ?>
            <div>
              <tr>
                ...
                <td class=""><?php echo $lista[$i]->getClienteId() ?></td>
                <td class=""><?php echo $lista[$i]->getTotal() ?></td>
                <td class=""><?php echo $lista[$i]->getFecha() ?></td>
                <td class=""><?php echo $lista[$i]->getEstado() ?></td>
                <?php if ($view == 'lista') { ?>
                  <td><a class="waves-effect waves-light btn  light blue darken-1" href='/dtg_mvc/views/pedidos/pedido_modifica.php?id=<?php echo $lista[$i]->id ?>'>Editar</a></td>
                  <td><a class="waves-effect waves-light btn  red darken-1" href='/dtg_mvc/views/pedidos/pedido_elimina.php?id=<?php echo $lista[$i]->id ?>'>Eliminar</a></td>
                <?php } elseif ($view == 'search') { ?>
                  <td><a class="waves-effect waves-light btn  red darken-1" href='/dtg_mvc/views/detalle_pedido/detalle_pedido_nuevo.php?pedido_id=<?php echo $lista[$i]->id ?>'>Seleccionar</a></td>
                <?php } ?>
              </tr>
            </div>
          <?php  } ?>
