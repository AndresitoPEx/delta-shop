...
<nav class="nav-extended">
  ...
  <a href="/dtg_mvc/index.php" class="brand-logo"><img class="responsive-img" src="../../assets/img/delta.png" width="250" style="margin-left:55px;"></a>
    ...
    <div class="container">
        ...
        <h2>Estas seguro de eliminar esta Categoria: </h2>

            <div class="form-group">
                <label for="nombre">Nombre:   </label>               
                <label class="form-control"><?php echo $categoria->getNombre() ?></label>
            </div>

                <hr>
                <td><a class="waves-effect waves-light btn  red darken-1" href='../../controller/categoria_controller.php?action=delete&id=<?php echo $categoria->id?>'>Eliminar</a></td>
                <td><a class="waves-effect waves-light btn  green darken-1" href='/dtg_mvc/views/categoria/categoria.php'>Cancelar</a></td>
</body>
